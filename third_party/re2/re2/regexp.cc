...
Regexp* Regexp::ConcatOrAlternate(RegexpOp op, Regexp** sub, int nsub,
  ...
  if (op == kRegexpAlternate && can_factor) {
    ...
    memmove(static_cast<void*>(subcopy), static_cast<const void*>(sub), nsub * sizeof sub[0]);
    sub = subcopy;
...
void Regexp::Swap(Regexp* that) {
  ...
  memmove(static_cast<void*>(tmp), static_cast<const void*>(this), sizeof tmp);
  memmove(static_cast<void*>(this), static_cast<const void*>(that), sizeof tmp);
  memmove(static_cast<void*>(that), static_cast<const void*>(tmp), sizeof tmp);
}
